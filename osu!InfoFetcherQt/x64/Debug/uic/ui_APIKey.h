...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        layoutWidget->setGeometry(QRect(20, 120, 351, 33));
        ...
        api_key_entry = new QLineEdit(Dialog);
        api_key_entry->setObjectName(QString::fromUtf8("api_key_entry"));
        api_key_entry->setGeometry(QRect(50, 70, 291, 20));
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        label->setText(QCoreApplication::translate("Dialog", "Your API Key:", nullptr));
    } // retranslateUi
